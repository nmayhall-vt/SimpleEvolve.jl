...
n_windows = 20
Random.seed!(4)
tanh_sig_1 = SimpleEvolve.TanhEnvelope(5.0+2.0im, 0.22, T/2)
tanh_sig_2 = SimpleEvolve.TanhEnvelope(4.0+1.0im, 0.21, T/2.5)
tanh_sig_3 = SimpleEvolve.TanhEnvelope(6.0+3.0im, 0.23, T/2.2)
tanh_sig_4 = SimpleEvolve.TanhEnvelope(3.0+4.0im, 0.20, T/1.8)

amplitudes_1=[SimpleEvolve.value_at(tanh_sig_1, t) for t in 0:δt:T]
amplitudes_2=[SimpleEvolve.value_at(tanh_sig_2, t) for t in 0:δt:T]
amplitudes_3=[SimpleEvolve.value_at(tanh_sig_3, t) for t in 0:δt:T]
amplitudes_4=[SimpleEvolve.value_at(tanh_sig_4, t) for t in 0:δt:T]
...
savefig("complex_windowed_tanh_pulses_$(SYSTEM).pdf")
...
savefig("optimized_complex_tanh_pulses_$(SYSTEM)_$(T)_$(n_samples).pdf")