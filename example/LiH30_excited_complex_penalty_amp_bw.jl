...
function gradient_ode!(Grad::Vector{Float64}, samples::Vector{Float64};
    ...
    cutoff = fs/2.1  # Cutoff frequency (GHz) 
    ...
    for i in 1:n_qubits
        ...
        filtered_pulse = lowpass_filter(pulse, cutoff, fs; order=order)
