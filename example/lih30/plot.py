...
filename = "lih30_dt_variation.jl.out"
...
for i in range(6):
    plt.plot(T_values, np.abs(data[0.2][i]), 
             marker='o', linestyle='-', 
...
plt.title('Energy Error vs Pulse Duration (δt = 0.2)', fontsize=16)
plt.tight_layout()
# plt.show()
plt.savefig('lih15_dt_variation_0.2.pdf', dpi=300)