...
T = 300.0
δt = 0.5
n_samples = round(Int, T / δt)
println("T=", T)
println("δt=", δt)
println("n_samples=", n_samples)
Cost_ham = npzread("qubit_op_H2O_tapered_1.00.npy")
# display(Cost_ham)
...
excited_configs = ["11101000", "11100100", "00000000"]
