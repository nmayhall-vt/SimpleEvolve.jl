...
for T in 110.0:2.0:160.0
    n_samples = Int(T*5)
    # for n_samples in [n_samples_g, 2 * n_samples_g, 4 * n_samples_g, 10 * n_samples_g]
        δt = T / n_samples
        println("T = ", T)
        println("δt = ", δt)
        ...
        weights  = [0.0, 0.02, 0.04, 0.08, 0.16, 0.32, 0.9]
        ...
        @save "samples_final_$(T)_$(SYSTEM)_$(n_samples).jld2" samples_final energies
    # end
end
