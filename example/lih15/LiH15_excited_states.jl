...
for T in 120.0:2.0:160.0
    ...
    device = choose_qubits(1:n_qubits, Transmon(
        ...
        Dict{QubitCoupling,Float64}(                # QUBIT COUPLING CONSTANTS
            ...
            QubitCoupling(3, 4) => 2π * 0.020,
            QubitCoupling(1, 3) => 2π * 0.02,
            QubitCoupling(2, 4) => 2π * 0.020,
    ...
    excited_configs = ["0101", "1001", "0110", "1010", "1100", "0000"]
    ψ_initial_excited = [
    ...
    function gradient_ode!(Grad, samples;Ω₀=2π + 0.02, λ=1.0, penalty=true)
