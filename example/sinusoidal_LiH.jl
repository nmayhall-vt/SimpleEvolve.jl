...
n_windows = 20
Random.seed!(4)
pulse_1= SimpleEvolve.SinusoidalSignal(1.0+1.0im,carrier_freqs[1], Float64(π/2))
pulse_2= SimpleEvolve.SinusoidalSignal(1.1+0.9im,carrier_freqs[2], Float64(3π/2))
pulse_3= SimpleEvolve.SinusoidalSignal(1.2+0.8im,carrier_freqs[3], Float64(π))
pulse_4= SimpleEvolve.SinusoidalSignal(0.9+1.1im,carrier_freqs[4], 0.0)
amplitudes_1=[SimpleEvolve.value_at(pulse_1, δt * i,n_samples) for i in 0:n_samples]
amplitudes_2=[SimpleEvolve.value_at(pulse_2, δt * i,n_samples) for i in 0:n_samples]
amplitudes_3=[SimpleEvolve.value_at(pulse_3, δt * i,n_samples) for i in 0:n_samples]
amplitudes_4=[SimpleEvolve.value_at(pulse_4, δt * i,n_samples) for i in 0:n_samples]
...
savefig("complex_windowed_sine_pulses_$(SYSTEM).pdf")
...
savefig("optimized_complex_sine_pulses_$(SYSTEM)_$(T)_$(n_samples).pdf")